...
DRY_RUN="${TIFA_CLEANUP_DRY_RUN:-1}"
AUDIO_CACHE_RETENTION_DAYS="${TIFA_AUDIO_CACHE_RETENTION_DAYS:-30}"
TTS_JOB_RETENTION_DAYS="${TIFA_TTS_JOB_RETENTION_DAYS:-7}"
LOG_RETENTION_DAYS="${TIFA_LOG_RETENTION_DAYS:-30}"
